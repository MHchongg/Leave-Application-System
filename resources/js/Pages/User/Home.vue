...
<template>
    <Layout>
        ...
        <el-container direction="vertical" class="gap-y-1.5 items-center">
            <h1 class="text-center text-3xl">Your Applied Leaves</h1>

            <Link href="/leave/create" as="button" type="button" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 self-end">
                Apply Leave
            </Link>
